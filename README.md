...
Logg IT-drift prosjekt (VG2)

Jeg startet prosjektet med å sette opp ruteren for å gi tilgang til nettverk og internett. Det oppstod først et problem fordi Wi-Fi-navnet (SSID) hadde blitt endret, noe som førte til at enhetene ikke klarte å koble seg til riktig nettverk. For å løse dette hentet vi en ny ruter med standard oppsett, og da fungerte tilkoblingen til internett som den skulle.
